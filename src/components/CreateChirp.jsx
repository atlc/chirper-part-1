...
class CreateChirp extends Component {
    ...
    render() {
        return (
            <>
                <Row>
                    <Col><h1 className="text-left text-white hr-thin pad-bot-10">{this.props.MainBody.isLoggedIn ? 'Home' : 'Trends Around The Globe'}</h1></Col>
                </Row>
